...
public class BaoCaoDoanhThuHangVe extends JFrame {
    ...
    public void LoadDataChuyenBay() {
    	...
    	try {
            ...
            String qry = "SELECT cb.MaChuyenBay as 'Ma Chuyen Bay',\r\n" + 
            		...
            		"	LEFT JOIN tblvedatcho dc ON dc.MaChuyenBay = cb.MaChuyenBay)*100 as 'Ti le',\r\n" + 
            		"	COALESCE(SUM(dc.SoLuong * dc.GiaVe),0) as 'DoanhThu'\r\n" + 
            		"	FROM tblchuyenbay cb\r\n" + 
            		"	LEFT JOIN tblvedatcho dc ON dc.MaChuyenBay = cb.MaChuyenBay\r\n" + 
            		"	group by cb.MaChuyenBay, dc.HangVe";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BaoCaoDoanhThuHangVe frame = new BaoCaoDoanhThuHangVe();
	...
	public BaoCaoDoanhThuHangVe() {
		...
		JLabel lblTháng = new JLabel("Hạng vé");
		...
		JLabel lbltitle = new JLabel("Báo cáo doanh thu bán vé các hạng vé");
